...
namespace Unire_Android
{
    ...
    public class Purple : ActionBarActivity
    {

        /* This is the class for tasks information.
         * The user can visit this activity at all times, to view older notifications.
         * Once a new purple notification is created, the user is guided to this class.
         */
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            notifications = new string[] { "09-02-2015 Summarize Text 2 : Angry Birds" };
