...
{
    [Activity(Label = "Unire", Icon = "@drawable/iconY", Theme = "@style/MyTheme")]
    public class Yellow : ActionBarActivity
    {

        /* This is the class for weather information.
         * The user can visit this activity at all times, to view older notifications.
         * Once a new yellow notification is created, the user is guided to this class.
         */
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            notifications = new string[] { "09-02-2015 09:00 Sunny with 10% chance of rain" };
