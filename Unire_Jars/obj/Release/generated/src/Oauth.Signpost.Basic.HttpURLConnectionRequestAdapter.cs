...
namespace Oauth.Signpost.Basic {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']"
	[global::Android.Runtime.Register ("oauth/signpost/basic/HttpURLConnectionRequestAdapter", DoNotGenerateAcw=true)]
	public partial class HttpURLConnectionRequestAdapter : global::Java.Lang.Object, global::Oauth.Signpost.Http.IHttpRequest {


		static IntPtr connection_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/field[@name='connection']"
		[Register ("connection")]
		protected global::Java.Net.HttpURLConnection Connection {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (Handle, connection_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (Handle, connection_jfieldId, native_value);
				} finally {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("oauth/signpost/basic/HttpURLConnectionRequestAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HttpURLConnectionRequestAdapter); }
		}

		protected HttpURLConnectionRequestAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_net_HttpURLConnection_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/constructor[@name='HttpURLConnectionRequestAdapter' and count(parameter)=1 and parameter[1][@type='java.net.HttpURLConnection']]"
		[Register (".ctor", "(Ljava/net/HttpURLConnection;)V", "")]
		public unsafe HttpURLConnectionRequestAdapter (global::Java.Net.HttpURLConnection p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (HttpURLConnectionRequestAdapter)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Oauth.Signpost.Basic.HttpURLConnectionRequestAdapter __this = global::Java.Lang.Object.GetObject<global::Oauth.Signpost.Basic.HttpURLConnectionRequestAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IDictionary<string, string> AllHeaders {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getAllHeaders' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.IO.Stream MessagePayload {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getMessagePayload' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Method {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string RequestUrl {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getRequestUrl' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='setRequestUrl' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='getHeader' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='setHeader' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.basic']/class[@name='HttpURLConnectionRequestAdapter']/method[@name='unwrap' and count(parameter)=0]"
		[Register ("unwrap", "()Ljava/net/HttpURLConnection;", "GetUnwrapHandler")]
		public virtual unsafe global::Java.Net.HttpURLConnection Unwrap ()
		{
			if (id_unwrap == IntPtr.Zero)
				id_unwrap = JNIEnv.GetMethodID (class_ref, "unwrap", "()Ljava/net/HttpURLConnection;");
			try {

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Java.Net.HttpURLConnection> (JNIEnv.CallObjectMethod  (Handle, id_unwrap), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Java.Net.HttpURLConnection> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "unwrap", "()Ljava/net/HttpURLConnection;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
