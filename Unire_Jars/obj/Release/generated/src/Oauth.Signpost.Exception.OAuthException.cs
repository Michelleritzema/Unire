...
namespace Oauth.Signpost.Exception {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='oauth.signpost.exception']/class[@name='OAuthException']"
	[global::Android.Runtime.Register ("oauth/signpost/exception/OAuthException", DoNotGenerateAcw=true)]
	public abstract partial class OAuthException : global::Java.Lang.Exception {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("oauth/signpost/exception/OAuthException", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.exception']/class[@name='OAuthException']/constructor[@name='OAuthException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe OAuthException (string p0)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.exception']/class[@name='OAuthException']/constructor[@name='OAuthException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe OAuthException (global::Java.Lang.Throwable p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.exception']/class[@name='OAuthException']/constructor[@name='OAuthException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe OAuthException (string p0, global::Java.Lang.Throwable p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
