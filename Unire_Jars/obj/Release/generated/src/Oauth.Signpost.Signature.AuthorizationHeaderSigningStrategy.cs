...
namespace Oauth.Signpost.Signature {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='AuthorizationHeaderSigningStrategy']"
	[global::Android.Runtime.Register ("oauth/signpost/signature/AuthorizationHeaderSigningStrategy", DoNotGenerateAcw=true)]
	public partial class AuthorizationHeaderSigningStrategy : global::Java.Lang.Object, global::Oauth.Signpost.Signature.ISigningStrategy {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("oauth/signpost/signature/AuthorizationHeaderSigningStrategy", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='AuthorizationHeaderSigningStrategy']/constructor[@name='AuthorizationHeaderSigningStrategy' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AuthorizationHeaderSigningStrategy ()
...
#pragma warning disable 0169
		...
		{
			global::Oauth.Signpost.Signature.AuthorizationHeaderSigningStrategy __this = global::Java.Lang.Object.GetObject<global::Oauth.Signpost.Signature.AuthorizationHeaderSigningStrategy> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='AuthorizationHeaderSigningStrategy']/method[@name='writeSignature' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='oauth.signpost.http.HttpRequest'] and parameter[3][@type='oauth.signpost.http.HttpParameters']]"
