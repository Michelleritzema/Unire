...
namespace Oauth.Signpost.Signature {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='HmacSha1MessageSigner']"
	[global::Android.Runtime.Register ("oauth/signpost/signature/HmacSha1MessageSigner", DoNotGenerateAcw=true)]
	public partial class HmacSha1MessageSigner : global::Oauth.Signpost.Signature.OAuthMessageSigner {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("oauth/signpost/signature/HmacSha1MessageSigner", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HmacSha1MessageSigner); }
		}

		protected HmacSha1MessageSigner (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='HmacSha1MessageSigner']/constructor[@name='HmacSha1MessageSigner' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe HmacSha1MessageSigner ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (HmacSha1MessageSigner)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Oauth.Signpost.Signature.HmacSha1MessageSigner __this = global::Java.Lang.Object.GetObject<global::Oauth.Signpost.Signature.HmacSha1MessageSigner> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override unsafe string SignatureMethod {
			// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='HmacSha1MessageSigner']/method[@name='getSignatureMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='oauth.signpost.signature']/class[@name='HmacSha1MessageSigner']/method[@name='sign' and count(parameter)=2 and parameter[1][@type='oauth.signpost.http.HttpRequest'] and parameter[2][@type='oauth.signpost.http.HttpParameters']]"
